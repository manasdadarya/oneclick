...
import com.ONECLICK.DONE.task_database.TaskContract;
import com.ONECLICK.DONE.task_database.TaskDatabaseHelper;
        ...
        switch (item.getItemId()) {
            case R.id.action_add_task:
                ...
                AlertDialog dialog = new AlertDialog.Builder(this)
                        .setTitle("what next?").setMessage("Your next wish to accomplish!!").setView(taskEdit)
